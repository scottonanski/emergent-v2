  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <button
        ...
        className="fixed bottom-20 right-6 w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 z-[9999]"
        title="Show Tutorial"
      >
